    ...
    <>
      ...
      {!isLoading && post && (
        ...
        >
          ...
          <div className="flex dark:text-zinc-500 text-zinc-400 text-sm items-center mt-5">
            <Link
              to={`/posts/author?user=${post?.user?._id}`}
              className="flex items-center dark:text-zinc-500 text-zinc-400 text-sm"
            >
